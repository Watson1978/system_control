...
srcdir = .
topdir = /Library/Frameworks/MacRuby.framework/Versions/0.7.1/usr/include/ruby-1.9.2
hdrdir = /Library/Frameworks/MacRuby.framework/Versions/0.7.1/usr/include/ruby-1.9.2
arch_hdrdir = /Library/Frameworks/MacRuby.framework/Versions/0.7.1/usr/include/ruby-1.9.2/$(arch)
VPATH = $(srcdir):$(arch_hdrdir)/ruby:$(hdrdir)/ruby
prefix = $(DESTDIR)/Library/Frameworks/MacRuby.framework/Versions/0.7.1/usr
exec_prefix = $(prefix)
...
debugflags = -g
warnflags = -Wall
CFLAGS   = -fno-common $(ARCH_FLAG) -fexceptions -fno-common -pipe $(cflags) -arch i386 -arch x86_64
...
ruby_version = 1.9.2
ruby = /Library/Frameworks/MacRuby.framework/Versions/0.7.1/usr/bin/macruby
RUBY = $(ruby)
RM = rm -f
